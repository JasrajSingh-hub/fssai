          ...
          <div className="overflow-hidden rounded-2xl border-2 border-[#25D366] bg-[#0b1c14] p-4 text-white shadow-2xl backdrop-blur-md transition hover:scale-[1.01] active:scale-[0.99]">
            <div className="flex items-start gap-3.5">
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="mt-2.5 flex flex-wrap items-center justify-between gap-2 pt-2 border-t border-emerald-900/60 text-[11px]">
                  ...
                  <div className="flex items-center gap-1.5">
                    ...
                    <button
                      ...
                      className="rounded bg-white/10 px-2 py-1 font-bold text-slate-300 hover:bg-white/20"
                    >
                      Dismiss
                    </button>
                  </div>
